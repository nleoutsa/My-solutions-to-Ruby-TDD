...
describe "#multiply" do
  ...
  it "multiplies two numbers" do
    ...
    multiply([1.1, 10]).should == 11
    multiply([1.5, 1.5]).should == 2.25
  end

  it "multiplies several numbers" do
    multiply([2, 3, 4]).should == 24
    multiply([0, 11223, -0.2, 8, 99, 1000000]).should == 0
    multiply([-1, 2, 3]).should == -6
    multiply([0.5, 1.5, 2, -15]) == -22.5
  end
...
describe "#power" do
  it "raises one number to the power of another number" do
    power(4444.8888, 0).should == 1
    power(2, 3).should == 8
    power(8, (1.0/3)).should == 2
    power(7, 1).should == 7
